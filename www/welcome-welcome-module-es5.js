...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["welcome-welcome-module"], {
  ...
  function srcAppWelcomeWelcomePageScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "h4 {\n  margin: 0px;\n}\n\np {\n  margin: 5px 0px 0px 0px;\n}\n\nion-row {\n  --border-bottom: black 1px solid;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppWelcomeWelcomePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var WelcomePage = /*#__PURE__*/function () {
      function WelcomePage(globals, storage, route, apiService) {
        var _this = this;
        ...
        this.storage.getItem('enterprisedId').then(function (result) {
          console.log(result);

          if (result) {
            _this.globals.enterprisedId = result;
          }
        });
        this.storage.getItem('userId').then(function (result) {
          console.log(result);

          if (result) {
            _this.globals.userId = result;
          }
        });
      }
      ...
      _createClass(WelcomePage, [{
        ...
        key: "goto_objectives",
        value: function goto_objectives() {
