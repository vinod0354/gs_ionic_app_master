...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pulse-pulse-module"], {
  /***/
  ...
  /***/
  function node_modulesDetectPassiveEventsLibIndexJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderEsm2015Ng5SliderJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "Ng5SliderModule", function () {
    ...
    var detect_passive_events__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! detect-passive-events */
    "./node_modules/detect-passive-events/lib/index.js");
    /* harmony import */


    var detect_passive_events__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(detect_passive_events__WEBPACK_IMPORTED_MODULE_4__);
    /* harmony import */
    ...
    var EventListenerHelper = /*#__PURE__*/function () {
      ...
      _createClass(EventListenerHelper, [{
        ...
        value: function attachPassiveEventListener(nativeElement, eventName, callback, throttleInterval) {
          ...
          listener.eventsSubscription = listener.events.pipe(!ValueHelper.isNullOrUndefined(throttleInterval) ? Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["throttleTime"])(throttleInterval, undefined, {
            leading: true,
            trailing: true
          }) : Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function () {}) // no-op
    ...
    var SliderHandleDirective = /*#__PURE__*/function (_SliderElementDirecti) {
      ...
      var _super2 = _createSuper(SliderHandleDirective);
      ...
      function SliderHandleDirective(elemRef, renderer) {
        ...
        _this2.role = '';
        _this2.tabindex = '';
        _this2.ariaOrientation = '';
        _this2.ariaLabel = '';
        _this2.ariaLabelledBy = '';
        _this2.ariaValueNow = '';
        _this2.ariaValueText = '';
        _this2.ariaValueMin = '';
        _this2.ariaValueMax = '';
        return _this2;
      }
    ...
    var SliderLabelDirective = /*#__PURE__*/function (_SliderElementDirecti2) {
      ...
      var _super3 = _createSuper(SliderLabelDirective);
      ...
      function SliderLabelDirective(elemRef, renderer) {
        ...
        _this3 = _super3.call(this, elemRef, renderer);
        _this3._value = null;
        return _this3;
      }
      /**
    ...
    var ModelChange = /*#__PURE__*/function (_ModelValues) {
      ...
      var _super4 = _createSuper(ModelChange);
    ...
    var SliderComponent = /*#__PURE__*/function () {
      ...
      function SliderComponent(renderer, elementRef, changeDetectionRef, zone) {
        ...
        this.valueChange = new _angular_core__WEBPACK_IMPORTED_MODULE_2__["EventEmitter"](); // Model for high value of slider. Not used in simple slider. For range slider, this is the high value.

        this.highValue = null; // Output for high value slider to support two-way bindings

        this.highValueChange = new _angular_core__WEBPACK_IMPORTED_MODULE_2__["EventEmitter"](); // An object with all the other options of the slider.
        // Each option can be updated at runtime and the slider will automatically be re-rendered.

        this.options = new Options(); // Event emitted when user starts interaction with the slider

        this.userChangeStart = new _angular_core__WEBPACK_IMPORTED_MODULE_2__["EventEmitter"](); // Event emitted on each change coming from user interaction

        this.userChange = new _angular_core__WEBPACK_IMPORTED_MODULE_2__["EventEmitter"](); // Event emitted when user finishes interaction with the slider
      ...
      _createClass(SliderComponent, [{
        ...
        value: function subscribeInputModelChangeSubject(interval) {
          ...
          this.inputModelChangeSubscription = this.inputModelChangeSubject.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["distinctUntilChanged"])(ModelChange.compare), // Hack to reset the status of the distinctUntilChanged() - if a "fake" event comes through with forceChange=true,
          // we forcefully by-pass distinctUntilChanged(), but otherwise drop the event
          Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])(function (modelChange) {
            return !modelChange.forceChange && !modelChange.internalChange;
          }), !ValueHelper.isNullOrUndefined(interval) ? Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["throttleTime"])(interval, undefined, {
            leading: true,
            trailing: true
          }) : Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function () {}) // no-op
          ).subscribe(function (modelChange) {
            return _this4.applyInputModelChange(modelChange);
          });
        }
        /**
         * @param {?=} interval
        ...
        value: function subscribeOutputModelChangeSubject(interval) {
          ...
          this.outputModelChangeSubscription = this.outputModelChangeSubject.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["distinctUntilChanged"])(ModelChange.compare), !ValueHelper.isNullOrUndefined(interval) ? Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["throttleTime"])(interval, undefined, {
            leading: true,
            trailing: true
          }) : Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function () {}) // no-op
          ).subscribe(function (modelChange) {
            return _this5.publishOutputModelChange(modelChange);
          });
        }
        /**
         * @return {?}
        ...
        value: function subscribeResizeObserver() {
          ...
          if (CompatibilityHelper.isResizeObserverAvailable()) {
            this.resizeObserver = new ResizeObserver(function () {
              return _this6.calculateViewDimensionsAndDetectChanges();
            });
        ...
        value: function publishOutputModelChange(modelChange) {
          ...
          emitOutputs = function emitOutputs() {
            _this7.valueChange.emit(modelChange.value);

            if (_this7.range) {
              _this7.highValueChange.emit(modelChange.highValue);
            }

            if (!ValueHelper.isNullOrUndefined(_this7.onChangeCallback)) {
              if (_this7.range) {
                _this7.onChangeCallback([modelChange.value, modelChange.highValue]);
              } else {
                _this7.onChangeCallback(modelChange.value);
              }
            }

            if (!ValueHelper.isNullOrUndefined(_this7.onTouchedCallback)) {
              if (_this7.range) {
                _this7.onTouchedCallback([modelChange.value, modelChange.highValue]);
              } else {
                _this7.onTouchedCallback(modelChange.value);
              }
            }
          };
        ...
        value: function applyStepsArrayOptions() {
          ...
          if (ValueHelper.isNullOrUndefined(this.viewOptions.translate)) {
            this.viewOptions.translate = function (modelValue) {
              if (_this8.viewOptions.bindIndexForStepsArray) {
                return String(_this8.getStepValue(modelValue));
              }
          ...
          this.viewOptions.getLegend = function (index) {
            var
            /** @type {?} */
            step = _this8.viewOptions.stepsArray[index];
            return step.legend;
          };
        }
        /**
        ...
        value: function manageElementsStyle() {
          ...
          if (this.sliderElementAnimateClass !== this.viewOptions.animate) {
            setTimeout(function () {
              _this9.sliderElementAnimateClass = _this9.viewOptions.animate;
            });
          }
        }
        /**
        ...
        value: function updateTicksScale() {
          ...
          newTicks = ticksArray.map(function (value) {
            var
            /** @type {?} */
            position = _this10.valueToPosition(value);

            if (_this10.viewOptions.vertical) {
              position = _this10.maxHandlePosition - position;
            }
            ...
            /** @type {?} */
            tick = new Tick();
            tick.selected = _this10.isTickSelected(value);
            tick.style = {
            ...
            if (tick.selected && !ValueHelper.isNullOrUndefined(_this10.viewOptions.getSelectionBarColor)) {
              tick.style['background-color'] = _this10.getSelectionBarColor();
            }

            if (!tick.selected && !ValueHelper.isNullOrUndefined(_this10.viewOptions.getTickColor)) {
              tick.style['background-color'] = _this10.getTickColor(value);
            }

            if (!ValueHelper.isNullOrUndefined(_this10.viewOptions.ticksTooltip)) {
              tick.tooltip = _this10.viewOptions.ticksTooltip(value);
              tick.tooltipPlacement = _this10.viewOptions.vertical ? 'right' : 'top';
            }

            if (_this10.viewOptions.showTicksValues && value % _this10.viewOptions.tickValueStep === 0) {
              tick.value = _this10.getDisplayValue(value, LabelType.TickValue);

              if (!ValueHelper.isNullOrUndefined(_this10.viewOptions.ticksValuesTooltip)) {
                tick.valueTooltip = _this10.viewOptions.ticksValuesTooltip(value);
                tick.valueTooltipPlacement = _this10.viewOptions.vertical ? 'right' : 'top';
              }
            }

            if (!ValueHelper.isNullOrUndefined(_this10.viewOptions.getLegend)) {
              var
              /** @type {?} */
              legend = _this10.viewOptions.getLegend(value);
        ...
        value: function bindEvents() {
          ...
          if (!this.viewOptions.onlyBindHandles) {
            this.selectionBarElement.on('mousedown', function (event) {
              return _this11.onBarStart(null, draggableRange, event, true, true, true);
            });
          }

          if (this.viewOptions.draggableRangeOnly) {
            this.minHandleElement.on('mousedown', function (event) {
              return _this11.onBarStart(PointerType.Min, draggableRange, event, true, true);
            });
            this.maxHandleElement.on('mousedown', function (event) {
              return _this11.onBarStart(PointerType.Max, draggableRange, event, true, true);
            });
          } else {
            this.minHandleElement.on('mousedown', function (event) {
              return _this11.onStart(PointerType.Min, event, true, true);
            });

            if (this.range) {
              this.maxHandleElement.on('mousedown', function (event) {
                return _this11.onStart(PointerType.Max, event, true, true);
              });
            }

            if (!this.viewOptions.onlyBindHandles) {
              this.fullBarElement.on('mousedown', function (event) {
                return _this11.onStart(null, event, true, true, true);
              });
              this.ticksElement.on('mousedown', function (event) {
                return _this11.onStart(null, event, true, true, true, true);
              });
            }
          }
          ...
          if (this.viewOptions.draggableRangeOnly) {
            ...
            if (!this.viewOptions.onlyBindHandles) {
              ...
              this.ticksElement.onPassive('touchstart', function (event) {
                return _this11.onStart(null, event, false, false, true, true);
              });
            }
          }
          ...
          if (this.viewOptions.keyboardSupport) {
            this.minHandleElement.on('focus', function () {
              return _this11.onPointerFocus(PointerType.Min);
            });

            if (this.range) {
              this.maxHandleElement.on('focus', function () {
                return _this11.onPointerFocus(PointerType.Max);
              });
            }
          }
        }
        ...
        value: function onStart(pointerType, event, bindMove, bindEnd, simulateImmediateMove, simulateImmediateEnd) {
          ...
          if (bindMove) {
            ...
            onMoveCallback = function onMoveCallback(e) {
              return _this12.dragging.active ? _this12.onDragMove(e) : _this12.onMove(e);
            };
        ...
        value: function onPointerFocus(pointerType) {
          ...
          pointerElement.on('blur', function () {
            return _this13.onPointerBlur(pointerElement);
          });
          pointerElement.on('keydown', function (event) {
            return _this13.onKeyboardEvent(event);
          });
          pointerElement.on('keyup', function () {
            return _this13.onKeyUp();
          });
          pointerElement.active = true;
          this.currentTrackingPointer = pointerType;
        ...
        set: function set(manualRefresh) {
          ...
          this.manualRefreshSubscription = manualRefresh.subscribe(function () {
            setTimeout(function () {
              return _this14.calculateViewDimensionsAndDetectChanges();
            });
          });
        }
        /**
        ...
        set: function set(triggerFocus) {
          ...
          this.triggerFocusSubscription = triggerFocus.subscribe(function (pointerType) {
            _this15.focusPointer(pointerType);
          });
        }
        /**
         * @return {?}
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsAsyncSubjectJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsBehaviorSubjectJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsInnerSubscriberJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsNotificationJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsObservableJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsObserverJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOuterSubscriberJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsReplaySubjectJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsSchedulerJs(module, exports, __webpack_require__) {
    "use strict";
    /**
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsSubjectJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsSubjectSubscriptionJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsSubscriberJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsSubscriptionJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsObservableArrayLikeObservableJs(module, exports, __webpack_require__) {
    "use strict";
    ...
    var ScalarObservable_1 = __webpack_require__(
    /*! ./ScalarObservable */
    "./node_modules/ng5-slider/node_modules/rxjs/observable/ScalarObservable.js");

    var EmptyObservable_1 = __webpack_require__(
    /*! ./EmptyObservable */
    ...
    exports.ArrayLikeObservable = ArrayLikeObservable; //# sourceMappingURL=ArrayLikeObservable.js.map
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsObservableArrayObservableJs(module, exports, __webpack_require__) {
    "use strict";
    ...
    exports.ArrayObservable = ArrayObservable; //# sourceMappingURL=ArrayObservable.js.map
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsObservableConnectableObservableJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsObservableEmptyObservableJs(module, exports, __webpack_require__) {
    "use strict";
    ...
    exports.EmptyObservable = EmptyObservable; //# sourceMappingURL=EmptyObservable.js.map
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsObservableFromObservableJs(module, exports, __webpack_require__) {
    "use strict";
    ...
    var IteratorObservable_1 = __webpack_require__(
    /*! ./IteratorObservable */
    "./node_modules/ng5-slider/node_modules/rxjs/observable/IteratorObservable.js");

    var ArrayObservable_1 = __webpack_require__(
    /*! ./ArrayObservable */
    "./node_modules/ng5-slider/node_modules/rxjs/observable/ArrayObservable.js");

    var ArrayLikeObservable_1 = __webpack_require__(
    /*! ./ArrayLikeObservable */
    "./node_modules/ng5-slider/node_modules/rxjs/observable/ArrayLikeObservable.js");
    ...
    exports.FromObservable = FromObservable; //# sourceMappingURL=FromObservable.js.map
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsObservableIteratorObservableJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsObservablePromiseObservableJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsObservableScalarObservableJs(module, exports, __webpack_require__) {
    "use strict";
    ...
    exports.ScalarObservable = ScalarObservable; //# sourceMappingURL=ScalarObservable.js.map
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsObservableTimerObservableJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsObservableConcatJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsObservableFromJs(module, exports, __webpack_require__) {
    "use strict";

    var FromObservable_1 = __webpack_require__(
    /*! ./FromObservable */
    "./node_modules/ng5-slider/node_modules/rxjs/observable/FromObservable.js");

    exports.from = FromObservable_1.FromObservable.create; //# sourceMappingURL=from.js.map
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsObservableMergeJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsObservableOfJs(module, exports, __webpack_require__) {
    "use strict";
    ...
    exports.of = ArrayObservable_1.ArrayObservable.of; //# sourceMappingURL=of.js.map
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsObservableRaceJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsObservableTimerJs(module, exports, __webpack_require__) {
    "use strict";

    var TimerObservable_1 = __webpack_require__(
    /*! ./TimerObservable */
    "./node_modules/ng5-slider/node_modules/rxjs/observable/TimerObservable.js");

    exports.timer = TimerObservable_1.TimerObservable.create; //# sourceMappingURL=timer.js.map
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsJs(module, exports, __webpack_require__) {
    "use strict";
    ...
    exports.zipAll = zipAll_1.zipAll; //# sourceMappingURL=operators.js.map
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsAuditJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsAuditTimeJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsBufferJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsBufferCountJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsBufferTimeJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsBufferToggleJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsBufferWhenJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsCatchErrorJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsCombineAllJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsCombineLatestJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsConcatJs(module, exports, __webpack_require__) {
    "use strict";
    ...
    var concat_2 = __webpack_require__(
    /*! ../observable/concat */
    "./node_modules/ng5-slider/node_modules/rxjs/observable/concat.js");
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsConcatAllJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsConcatMapJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsConcatMapToJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsCountJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsDebounceJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsDebounceTimeJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsDefaultIfEmptyJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsDelayJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsDelayWhenJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsDematerializeJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsDistinctJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsDistinctUntilChangedJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsDistinctUntilKeyChangedJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsElementAtJs(module, exports, __webpack_require__) {
    "use strict";
    ...
    }(Subscriber_1.Subscriber); //# sourceMappingURL=elementAt.js.map
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsEveryJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsExhaustJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsExhaustMapJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsExpandJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsFilterJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsFinalizeJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsFindJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsFindIndexJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsFirstJs(module, exports, __webpack_require__) {
    "use strict";
    ...
    }(Subscriber_1.Subscriber); //# sourceMappingURL=first.js.map
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsGroupByJs(module, exports, __webpack_require__) {
    "use strict";
    ...
    var FastMap_1 = __webpack_require__(
    /*! ../util/FastMap */
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsIgnoreElementsJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsIsEmptyJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsLastJs(module, exports, __webpack_require__) {
    "use strict";
    ...
    }(Subscriber_1.Subscriber); //# sourceMappingURL=last.js.map
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsMapJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsMapToJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsMaterializeJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsMaxJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsMergeJs(module, exports, __webpack_require__) {
    "use strict";
    ...
    var merge_2 = __webpack_require__(
    /*! ../observable/merge */
    "./node_modules/ng5-slider/node_modules/rxjs/observable/merge.js");
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsMergeAllJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsMergeMapJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsMergeMapToJs(module, exports, __webpack_require__) {
    "use strict";
    ...
    exports.MergeMapToSubscriber = MergeMapToSubscriber; //# sourceMappingURL=mergeMapTo.js.map
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsMergeScanJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsMinJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsMulticastJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsObserveOnJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsOnErrorResumeNextJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsPairwiseJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsPartitionJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsPluckJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsPublishJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsPublishBehaviorJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsPublishLastJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsPublishReplayJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsRaceJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsReduceJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsRefCountJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsRepeatJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsRepeatWhenJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsRetryJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsRetryWhenJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsSampleJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsSampleTimeJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsScanJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsSequenceEqualJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsShareJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsShareReplayJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsSingleJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsSkipJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsSkipLastJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsSkipUntilJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsSkipWhileJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsStartWithJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsSwitchAllJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsSwitchMapJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsSwitchMapToJs(module, exports, __webpack_require__) {
    "use strict";
    ...
    }(OuterSubscriber_1.OuterSubscriber); //# sourceMappingURL=switchMapTo.js.map
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsTakeJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsTakeLastJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsTakeUntilJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsTakeWhileJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsTapJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsThrottleJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsThrottleTimeJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsTimeIntervalJs(module, exports, __webpack_require__) {
    "use strict";
    ...
    }(Subscriber_1.Subscriber); //# sourceMappingURL=timeInterval.js.map
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsTimeoutJs(module, exports, __webpack_require__) {
    "use strict";
    ...
    }(Subscriber_1.Subscriber); //# sourceMappingURL=timeout.js.map
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsTimeoutWithJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsTimestampJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsToArrayJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsWindowJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsWindowCountJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsWindowTimeJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsWindowToggleJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsWindowWhenJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsWithLatestFromJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsZipJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsOperatorsZipAllJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsSchedulerActionJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsSchedulerAsyncActionJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsSchedulerAsyncSchedulerJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsSchedulerQueueActionJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsSchedulerQueueSchedulerJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsSchedulerAsyncJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsSchedulerQueueJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsSymbolIteratorJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsSymbolObservableJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsSymbolRxSubscriberJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsUtilArgumentOutOfRangeErrorJs(module, exports, __webpack_require__) {
    "use strict";
    ...
    exports.ArgumentOutOfRangeError = ArgumentOutOfRangeError; //# sourceMappingURL=ArgumentOutOfRangeError.js.map
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsUtilEmptyErrorJs(module, exports, __webpack_require__) {
    "use strict";
    ...
    exports.EmptyError = EmptyError; //# sourceMappingURL=EmptyError.js.map
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsUtilFastMapJs(module, exports, __webpack_require__) {
    "use strict";
    ...
    exports.FastMap = FastMap; //# sourceMappingURL=FastMap.js.map
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsUtilMapJs(module, exports, __webpack_require__) {
    "use strict";
    ...
    var MapPolyfill_1 = __webpack_require__(
    /*! ./MapPolyfill */
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsUtilMapPolyfillJs(module, exports, __webpack_require__) {
    "use strict";
    ...
    exports.MapPolyfill = MapPolyfill; //# sourceMappingURL=MapPolyfill.js.map
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsUtilObjectUnsubscribedErrorJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsUtilSetJs(module, exports, __webpack_require__) {
    "use strict";
    ...
    exports.Set = root_1.root.Set || minimalSetImpl(); //# sourceMappingURL=Set.js.map
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsUtilTimeoutErrorJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsUtilUnsubscriptionErrorJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsUtilErrorObjectJs(module, exports, __webpack_require__) {
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsUtilIdentityJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsUtilIsArrayJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsUtilIsArrayLikeJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsUtilIsDateJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsUtilIsFunctionJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsUtilIsNumericJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsUtilIsObjectJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsUtilIsPromiseJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsUtilIsSchedulerJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsUtilNoopJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsUtilNotJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsUtilPipeJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsUtilRootJs(module, exports, __webpack_require__) {
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsUtilSubscribeToResultJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsUtilToSubscriberJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesNg5SliderNode_modulesRxjsUtilTryCatchJs(module, exports, __webpack_require__) {
    "use strict";
  ...
  /***/
  "./node_modules/raw-loader/dist/cjs.js!./src/app/pulse/pulse.page.html":
  /*!*****************************************************************************!*\
    !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/pulse/pulse.page.html ***!
    \*****************************************************************************/
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPulsePulsePageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "<ion-header [translucent]=\"true\">\n  <ion-toolbar>\n    <ion-buttons slot=\"start\">\n      <ion-menu-button style=\"color: #f09d2e;\"></ion-menu-button>\n    </ion-buttons>\n    <ion-title color=\"Medium\">Pulse</ion-title>\n    <ion-buttons slot=\"end\">\n      <!-- <ion-button style=\"color: #f09d2e;\">\n        <ion-icon style=\"color: #f09d2e;\" name=\"search\"></ion-icon>\n      </ion-button>\n      <ion-button  style=\"color: #f09d2e;\">\n        <ion-icon style=\"color: #f09d2e;\" name=\"funnel\"></ion-icon>\n      </ion-button> -->\n      <ion-button style=\"color: #f09d2e;\">\n        <ion-icon style=\"color: #f09d2e;\" name=\"ellipsis-vertical\"></ion-icon>\n      </ion-button>\n    </ion-buttons>\n  </ion-toolbar>\n</ion-header>\n\n\n<ion-content>\n  <form>\n  <div [ngSwitch]=\"segment\">\n\n    <ion-list *ngSwitchCase=\"'personal'\" class=\"padding\">\n      <!--Ng Slider -->\n        <div class=\"form-group custom-slider\" style=\"padding-top:30px;\">\n          <ng5-slider [(value)]=\"value\" [options]=\"options\"></ng5-slider>\n       </div>\n        <!--Ng Slider -->\n        <div class=\"form-group\" style=\"padding: 10px;\">\n          <div style=\"padding-bottom: 30px;padding-top:15px;\">\n            <ion-label >\n              I feel fulfilled personally\n            </ion-label>\n          </div>\n          <ion-input type=\"text\" class=\"form-control input-class\" placeholder=\"Add Comments\"></ion-input>\n        </div>\n        <!--Button-->\n      <div class=\"text-center\" style=\"padding-top: 20px;\">\n      <label style=\"color: #e98604;\"><ion-icon name=\"lock-closed-outline\" style=\"padding-right:10px;\"></ion-icon>Only you can see this</label><br><br>\n      <ion-button  class=\"action-btn\" shape=\"round\"><ion-icon name=\"add-circle\" style=\"padding-right:10px;\"></ion-icon>Add</ion-button>\n    </div>\n    <!--button-->\n\n    <!-- History Table -->\n    <div class=\"col-12 padding\">\n      <ion-label>History</ion-label>\n   </div>\n    <ion-card class=\"card\" style=\"max-height: 68vh;border-bottom-left-radius: 10px; border-bottom-right-radius: 10px; overflow-x: hidden;\">\n      <ion-card-content style=\"padding: 10px 15px 10px 15px !important;overflow-y: auto\">\n                <div class=\"col-12 padding\">\n                  <ion-label>2020</ion-label>\n                </div>\n              <div class=\"table-responsive\">\n                  \n                  <table>\n                    <tbody>\n                    <tr>\n                        <td style=\"vertical-align: middle;\">Jun 26</td>\n                        <td>Compliment from boss</td>\n                        <td><ion-icon name=\"lock-closed-outline\"></ion-icon></td>                      \n                    </tr>\n                    <tr>\n                        <td style=\"vertical-align: middle;\">Jun 19</td>\n                        <td>Compliment from boss</td>\n                        <td><ion-icon name=\"lock-closed-outline\"></ion-icon></td>\n                    </tr>\n                    <tr>\n                        <td style=\"vertical-align: middle;\">Jun 03 </td>\n                        <td>Compliment from boss</td>\n                        <td><ion-icon name=\"lock-closed-outline\"></ion-icon></td>\n                    </tr>\n                  \n                    </tbody>\n                  </table>\n              </div>\n              <div class=\"col-12 padding\">\n                  <ion-label>2019</ion-label>\n              </div>\n              <div class=\"table-responsive\">\n                  <table>\n                    <tr>\n                        <td style=\"vertical-align: middle;\">Jun 26</td>\n                        <td>Compliment from boss</td>\n                        <td><ion-icon name=\"lock-closed-outline\"></ion-icon></td>                      \n                    </tr>\n                    <tr>\n                        <td style=\"vertical-align: middle;\">Jun 19</td>\n                        <td>Compliment from boss</td>\n                        <td><ion-icon name=\"lock-closed-outline\"></ion-icon></td>\n                    </tr>\n                    <tr>\n                        <td style=\"vertical-align: middle;\">Jun 03 </td>\n                        <td>Compliment from boss</td>\n                        <td><ion-icon name=\"lock-closed-outline\"></ion-icon></td>\n                    </tr>\n                    <tr>\n                        <td style=\"vertical-align: middle;\">Jun 26</td>\n                        <td>Compliment from boss</td>\n                        <td><ion-icon name=\"lock-closed-outline\"></ion-icon></td>                      \n                    </tr>\n                    <tr>\n                        <td style=\"vertical-align: middle;\">Jun 19</td>\n                        <td>Compliment from boss</td>\n                        <td><ion-icon name=\"lock-closed-outline\"></ion-icon></td>\n                    </tr>\n                    <tr>\n                        <td style=\"vertical-align: middle;\">Jun 03 </td>\n                        <td>Compliment from boss</td>\n                        <td><ion-icon name=\"lock-closed-outline\"></ion-icon></td>\n                    </tr>\n                    <tr>\n                        <td style=\"vertical-align: middle;\">Jun 26</td>\n                        <td>Compliment from boss</td>\n                        <td><ion-icon name=\"lock-closed-outline\"></ion-icon></td>                      \n                    </tr>\n                    <tr>\n                        <td style=\"vertical-align: middle;\">Jun 19</td>\n                        <td>Compliment from boss</td>\n                        <td><ion-icon name=\"lock-closed-outline\"></ion-icon></td>\n                    </tr>\n                    <tr>\n                        <td style=\"vertical-align: middle;\">Jun 03 </td>\n                        <td>Compliment from boss</td>\n                        <td><ion-icon name=\"lock-closed-outline\"></ion-icon></td>\n                    </tr>\n                  </table>\n              </div>\n               <!-- History Table -->\n      </ion-card-content>\n    </ion-card>\n    </ion-list>\n    <!-- History Table -->\n\n\n   \n\n\n    <ion-list *ngSwitchCase=\"'profession'\" class=\"padding\">\n       <!--Ng Slider -->\n        <div class=\"form-group custom-slider\" style=\"padding-top:30px;\">\n          <ng5-slider [(value)]=\"value2\" [options]=\"options2\"></ng5-slider>\n       </div>\n        <!--Ng Slider -->\n      <div class=\"form-group\" style=\"padding: 10px;\">\n        <div class=\"\" style=\"padding-bottom: 30px;padding-top:15px;\">\n          <ion-label >\n          I feel engaged professionally\n        </ion-label></div>\n      </div>\n       <!--Ng Slider -->\n        <div class=\"form-group custom-slider2\" style=\"padding-top:30px;\">\n          <ng5-slider [(value)]=\"value3\" [options]=\"options3\"></ng5-slider>\n       </div>\n        <!--Ng Slider -->\n      <div class=\"form-group\" style=\"padding: 10px;\">\n        <div class=\"\" style=\"padding-bottom: 30px;padding-top: 15px;\">\n          <ion-label>\n            I expect to be here 12 months\n          </ion-label>\n        </div>\n        <ion-input type=\"text\" class=\"form-control input-class\" placeholder=\"Add Comments\"></ion-input>\n      </div>\n      <div class=\"text-center\" style=\"padding-top: 20px;\">\n        <label><ion-icon name=\"lock-open-outline\" style=\"padding-right: 10px;\"></ion-icon>Submit with name</label><br><br>\n        <label style=\"color: #1089CE;\"><ion-icon name=\"lock-closed-outline\" style=\"padding-right: 10px;color: #1089CE;\"></ion-icon>Submit Anonymously</label><br><br>\n        <ion-button class=\"action-btn\" shape=\"round\"><ion-icon name=\"arrow-up-circle\" style=\"padding-right:5px;\"></ion-icon>Submit</ion-button>\n      </div>\n\n       <!-- History Table -->\n\n      <div class=\"col-12 padding\">\n        <ion-label>History</ion-label>\n     </div>\n      <ion-card class=\"card\" style=\"max-height: 68vh;border-bottom-left-radius: 10px; border-bottom-right-radius: 10px; overflow-x: hidden;\">\n        <ion-card-content style=\"padding: 10px 15px 10px 15px !important;overflow-y: auto\">\n                <div class=\"col-12 padding\">\n                    <ion-label>2020</ion-label>\n                  </div>\n                <div class=\"table-responsive\">\n                    \n                    <table>\n                      <tbody>\n                      <tr>\n                          <td style=\"vertical-align: middle;\">Jun 26</td>\n                          <td>Compliment from boss</td>\n                          <td><ion-icon name=\"lock-open-outline\"></ion-icon></td>                      \n                      </tr>\n                      <tr>\n                          <td style=\"vertical-align: middle;\">Jun 19</td>\n                          <td>Compliment from boss</td>\n                          <td> <ion-icon name=\"lock-open-outline\"></ion-icon></td>\n                      </tr>\n                      <tr>\n                          <td style=\"vertical-align: middle;\">Jun 03 </td>\n                          <td>Compliment from boss</td>\n                          <td><ion-icon name=\"lock-open-outline\"></ion-icon></td>\n                      </tr>\n                    \n                      </tbody>\n                    </table>\n                </div>\n                <div class=\"col-12 padding\">\n                    <ion-label>2019</ion-label>\n                </div>\n                <div class=\"table-responsive\">\n                    <table>\n                      <tr>\n                          <td style=\"vertical-align: middle;\">Jun 26</td>\n                          <td>Compliment from boss</td>\n                          <td><ion-icon name=\"lock-open-outline\"></ion-icon></td>                      \n                      </tr>\n                      <tr>\n                          <td style=\"vertical-align: middle;\">Jun 19</td>\n                          <td>Compliment from boss</td>\n                          <td><ion-icon name=\"lock-open-outline\"></ion-icon></td>\n                      </tr>\n                      <tr>\n                          <td style=\"vertical-align: middle;\">Jun 03 </td>\n                          <td>Compliment from boss</td>\n                          <td><ion-icon name=\"lock-open-outline\"></ion-icon></td>\n                      </tr>\n                      <tr>\n                          <td style=\"vertical-align: middle;\">Jun 26</td>\n                          <td>Compliment from boss</td>\n                          <td><ion-icon name=\"lock-open-outline\"></ion-icon></td>                      \n                      </tr>\n                      <tr>\n                          <td style=\"vertical-align: middle;\">Jun 19</td>\n                          <td>Compliment from boss</td>\n                          <td><ion-icon name=\"lock-open-outline\"></ion-icon></td>\n                      </tr>\n                      <tr>\n                          <td style=\"vertical-align: middle;\">Jun 03 </td>\n                          <td>Compliment from boss</td>\n                          <td> <ion-icon name=\"lock-open-outline\"></ion-icon></td>\n                      </tr>\n                      <tr>\n                          <td style=\"vertical-align: middle;\">Jun 26</td>\n                          <td>Compliment from boss</td>\n                          <td><ion-icon name=\"lock-open-outline\"></ion-icon></td>                      \n                      </tr>\n                      <tr>\n                          <td style=\"vertical-align: middle;\">Jun 19</td>\n                          <td>Compliment from boss</td>\n                          <td><ion-icon name=\"lock-open-outline\"></ion-icon></td>\n                      </tr>\n                      <tr>\n                          <td style=\"vertical-align: middle;\">Jun 03 </td>\n                          <td>Compliment from boss</td>\n                          <td><ion-icon name=\"lock-open-outline\"></ion-icon></td>\n                      </tr>\n                    </table>\n                </div>\n        </ion-card-content>\n      </ion-card>\n\n       <!-- History Table -->\n       \n    </ion-list>\n  </div>\n\n</form>\n  <div style=\"margin-top: 60px;\"></div>\n</ion-content>\n\n<!-- <ion-footer>\n  <ion-segment class=\"segment-button\" [(ngModel)]=\"segment\"  (ionChange)=\"segmentChanged($event)\">\n    \n    <ion-segment-button value=\"profession\">\n      Professional\n    </ion-segment-button>\n    <ion-segment-button value=\"personal\">\n      Personal\n    </ion-segment-button>\n\n  </ion-segment>\n</ion-footer> -->\n<ion-fab vertical=\"bottom\" slot=\"fixed\" style=\"width: 100%;flex-direction: row; justify-content: center;\">\n  <ion-row>\n    <ion-col>\n      <ion-segment class=\"segment-button\" [(ngModel)]=\"segment\"  (ionChange)=\"segmentChanged($event)\">\n    \n        <ion-segment-button value=\"profession\">\n          Professional\n        </ion-segment-button>\n        <ion-segment-button value=\"personal\">\n          Personal\n        </ion-segment-button>\n    \n      </ion-segment>\n    </ion-col>\n  </ion-row>\n</ion-fab>";
    /***/
  },
  ...
  /***/
  function node_modulesRxjsCompat_esm2015SubscriptionJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /*! exports provided: PulsePageRoutingModule */

  /***/
  function srcAppPulsePulseRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PulsePageRoutingModule", function () {
      return PulsePageRoutingModule;
    });
    /* harmony import */
    ...
    var _pulse_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./pulse.page */
    "./src/app/pulse/pulse.page.ts");

    var routes = [{
      path: '',
      component: _pulse_page__WEBPACK_IMPORTED_MODULE_3__["PulsePage"]
    }];

    var PulsePageRoutingModule = function PulsePageRoutingModule() {
      _classCallCheck(this, PulsePageRoutingModule);
    };

    PulsePageRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppPulsePulseModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PulsePageModule", function () {
    ...
    var _pulse_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./pulse-routing.module */
    "./src/app/pulse/pulse-routing.module.ts");
    /* harmony import */


    var _pulse_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./pulse.page */
    "./src/app/pulse/pulse.page.ts");
    /* harmony import */
    ...
    var PulsePageModule = function PulsePageModule() {
      _classCallCheck(this, PulsePageModule);
    };

    PulsePageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _pulse_routing_module__WEBPACK_IMPORTED_MODULE_5__["PulsePageRoutingModule"], ng5_slider__WEBPACK_IMPORTED_MODULE_7__["Ng5SliderModule"]],
  ...
  /***/
  function srcAppPulsePulsePageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = ".padding {\n  padding: 10px;\n}\n\n.buttons {\n  text-align: center;\n  font-size: 20px;\n  width: 175px;\n  height: 72px;\n  --background: #9ac81b;\n  color: #ffffff;\n  --border-radius:36px;\n  --box-shadow:13px 6px 10px -2px gray;\n  text-transform: capitalize;\n}\n\n.text-center {\n  text-align: center;\n}\n\ntable {\n  width: 100%;\n}\n\ntable, td, tr {\n  border: 1px solid #dee2e6;\n  background-color: rgba(255, 255, 255, 0.966);\n}\n\ntd {\n  padding: 10px;\n}\n\ntable.table tr:hover td {\n  color: #1089CE;\n  border: 1px solid #1089CE;\n}\n\n.card {\n  box-shadow: 10px 10px 10px -10px inset;\n  overflow: scroll;\n}\n\n.text-size {\n  font-size: 17px;\n}\n\n.input-class {\n  border: 1px solid #e98604;\n  min-height: 70px;\n  box-shadow: 3px 2px 10px -5px inset;\n}\n\n.wrap {\n  box-sizing: border-box;\n  height: 100px;\n  margin: 0 auto;\n  padding: 30px 10px;\n  width: 460px;\n}\n\n.wrap .label {\n  text-align: center;\n}\n\ntable, tr, td {\n  border: 1px solid #ddd;\n  text-align: left;\n}\n\ntable {\n  border-collapse: collapse;\n  width: 100%;\n}\n\ntr:hover {\n  border: 2px solid #1089CE;\n  color: #1089CE;\n  font-weight: bold;\n}\n\nth, td {\n  padding: 10px;\n}\n\n/* width */\n\n::-webkit-scrollbar {\n  width: 10px;\n}\n\n/* Track */\n\n::-webkit-scrollbar-track {\n  box-shadow: inset 0 0 5px grey;\n  border-radius: 10px;\n}\n\n/* Handle */\n\n::-webkit-scrollbar-thumb {\n  background: linear-gradient(114deg, #c354a3 22%, #3668a4 82%);\n  border-radius: 10px;\n}\n\n/* Handle on hover */\n\n::-webkit-scrollbar-thumb:hover {\n  background: #1089CE;\n}\n\nion-segment {\n  --background:white;\n  border: 1px solid lightgray;\n  border-radius: 2rem;\n}\n\nion-segment-button {\n  width: 50px;\n  height: 50px;\n  text-transform: capitalize;\n  --indicator-box-shadow:transparent !important;\n  --border-radius:34px !important;\n  --border-color:lightgray;\n  --padding:0 0.2em;\n  --margin:0.5em;\n  --background:white;\n  --color-hover:rgb(125, 62, 120);\n  --background-checked: linear-gradient(114deg, #c354a3 22%, #3668a4 82%);\n  --color-checked:rgb(255,255,255);\n  --indicator-color:transparent !important ;\n}\n\n::ng-deep .custom-slider .ng5-slider .ng5-slider-bar {\n  background: linear-gradient(114deg, #c354a3 22%, #3668a4 82%);\n  height: 2px;\n}\n\n::ng-deep .custom-slider .ng5-slider .ng5-slider-pointer {\n  width: 25px;\n  height: 25px;\n  bottom: 2px;\n  background-color: #ab2e8e;\n  border: none;\n}\n\n::ng-deep .custom-slider .ng5-slider .ng5-slider-pointer:after {\n  display: none;\n}\n\n::ng-deep .custom-slider .ng5-slider .ng5-slider-tick {\n  width: 0px;\n  height: 10px;\n  margin-left: 4px;\n  border-radius: 0;\n  background: #ffe4d1;\n  top: -1px;\n}\n\n::ng-deep .custom-slider2 .ng5-slider .ng5-slider-bar {\n  background: linear-gradient(114deg, #3668a4 22%, #c354a3 82%);\n  height: 2px;\n}\n\n::ng-deep .custom-slider2 .ng5-slider .ng5-slider-pointer {\n  width: 25px;\n  height: 25px;\n  bottom: 2px;\n  background-color: #4375bc;\n  border: none;\n}\n\n::ng-deep .custom-slider2 .ng5-slider .ng5-slider-pointer:after {\n  display: none;\n}\n\n::ng-deep .custom-slider2 .ng5-slider .ng5-slider-pointer:active {\n  border: none;\n}\n\n::ng-deep .custom-slider2 .ng5-slider .ng5-slider-tick {\n  width: 0px;\n  height: 10px;\n  margin-left: 4px;\n  border-radius: 0;\n  background: #ffe4d1;\n  top: -1px;\n}\n\n.action-btn {\n  width: 175px;\n  height: 72px;\n  font-size: 15px;\n  font-weight: bold;\n  --background: #9ac81b;\n  --box-shadow: 0 6px 12px 0 rgba(0, 0, 0, 0.3), 0 -6px 12px 0 rgba(255, 255, 255, 0.5);\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  /***/
  function srcAppPulsePulsePageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PulsePage", function () {
      return PulsePage;
    });
    /* harmony import */
    ...
    var PulsePage = /*#__PURE__*/function () {
      function PulsePage(navCtrl) {
        _classCallCheck(this, PulsePage);
    ...
    PulsePage.ctorParameters = function () {
      return [{
        type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"]
      }];
    };

    PulsePage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-pulse',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./pulse.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pulse/pulse.page.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./pulse.page.scss */
      "./src/app/pulse/pulse.page.scss"))["default"]]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"]])], PulsePage);
    /***/
  }
}]);
//# sourceMappingURL=pulse-pulse-module-es5.js.map