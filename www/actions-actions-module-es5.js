...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["actions-actions-module"], {
  ...
  function srcAppActionsActionsModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _actions_routing_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./actions-routing.module */
    "./src/app/actions/actions-routing.module.ts");
    /* harmony import */


    var _actions_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./actions.page */
    "./src/app/actions/actions.page.ts");
    /* harmony import */
    ...
    var _action_date_action_date_module__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    ...
    ActionsPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      imports: [_mobiscroll_angular__WEBPACK_IMPORTED_MODULE_1__["MbscModule"], _angular_common__WEBPACK_IMPORTED_MODULE_3__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["IonicModule"], _angular_cdk_drag_drop__WEBPACK_IMPORTED_MODULE_8__["DragDropModule"], _actions_routing_module__WEBPACK_IMPORTED_MODULE_6__["ActionsPageRoutingModule"], _search_search_module__WEBPACK_IMPORTED_MODULE_10__["SearchPageModule"], _pipes_pipes_module__WEBPACK_IMPORTED_MODULE_11__["PipesModule"], _action_creation_action_creation_module__WEBPACK_IMPORTED_MODULE_9__["ActionCreationPageModule"], _action_date_action_date_module__WEBPACK_IMPORTED_MODULE_12__["ActionDatePageModule"]],
  ...
  function srcAppActionsActionsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _action_date_action_date_page__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ../action-date/action-date.page */
    ...
    var ActionsPage = /*#__PURE__*/function () {
      function ActionsPage(datapipe, platform, modalController, api, globals) {
        var _this52 = this;
        ...
        this.days = [];
        this.daysRequired = 6;
        this.collapse_all = true; //Toggle//

        this.categoryToggle = false; // Do Tabs //
        ...
        this.isPrActive = "#363648"; // End Do Tabs //
        ...
        this.platform.ready().then(function () {
          if (_this52.platform.is('android')) {
            console.log('android');
            _this52.deviceType = 'android';
          } else if (_this52.platform.is('ios')) {
            console.log('ios');
            _this52.deviceType = 'ios';
          } else {
      ...
      _createClass(ActionsPage, [{
        ...
        value: function ngOnInit() {
          ...
          for (var i = 0; i <= this.daysRequired; i++) {
            if (i == 0) {
              this.days.push({
              ...
              this.days.push({
                displayDate: moment__WEBPACK_IMPORTED_MODULE_9__().add(i, 'days').format('dddd Do'),
                formatDate: moment__WEBPACK_IMPORTED_MODULE_9__().add(i, 'days').format('YYYY-MM-DD')
              });
            }
          }
        ...
        key: "segmentTab",
        value: function segmentTab(ev) {
          console.log('Segment changed', ev);
        } //Do Tab Click//

      }, {
        key: "click_Category",
        value: function click_Category() {
        ...
        value: function openModal(type, input) {
          return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
            ...
            var Categories_duplicate, i, j, initialState, modal;
                  ...
                  case 0:
                    ...
                    for (i = 0; i < this.allCatogeries.length; i++) {
                      ...
                      if (i == this.allCatogeries.length - 1) {
                        for (j = 0; j < Categories_duplicate.length; j++) {
                  ...
                  case 6:
                    ...
                    modal.onDidDismiss().then(function (dataReturned) {
                      if (dataReturned !== null) {
                        ...
                        _this53.markedDay = new Date(dataReturned.data.data.target_date);

                        _this53.processCalenderEvents(_this53.markedDay);

                        if (dataReturned.data.data.close != "CANCEL") {
                          _this53.getCategoriesforActions();
        ...
        key: "clickedheader",
        value: function clickedheader(i) {
            ...
            if (result.status == 200) {
              ...
              for (var i = 0; i < result.body.length; i++) {
                if (result.body[i].name.toLowerCase().indexOf("category") == -1) {
                  _this54.allCatogeries.push(result.body[i]);
                }

                if (i == result.body.length - 1) {
                  _this54.allCatogeriesActions = _this54.allCatogeries;

                  for (var _i2 = 0; _i2 < _this54.allCatogeries.length; _i2++) {
                    if (_this54.allCatogeries[_i2].name == 'Miscellaneous') {
                      _this54.miscellaneousCatogeryID = _this54.allCatogeries[_i2].category_id;
                    }
                  }

                  _this54.getActionsUsingCategoryIDs();
                }
              } // this.allCatogeries = result.body;
              // this.allCatogeriesActions = result.body;

            } else if (result.status == 204) {
              _this54.globals.hideLoading();
            } else {
              _this54.globals.hideLoading();
            }
          }, function (err) {
                      ...
                      return regeneratorRuntime.wrap(function _loop$(_context2) {
                        while (1) {
                          switch (_context2.prev = _context2.next) {
                            case 0:
                              _context2.next = 2;
                              return _this55.api.getActions(_this55.globals.enterprisedId, _this55.globals.userId, _this55.allCatogeries[i].category_id).subscribe(function (result) {
                                apiCallingCount++;
                                ...
                                if (result.status == 200) {
                                  ...
                                  console.log(result.body);
                                  _this55.allCatogeriesActions[i]['actions'] = result.body;
                                } else if (result.status == 204) {
                                  // this.allActions.push([]);
                                  _this55.allCatogeriesActions[i]['actions'] = [];
                                } else {
                                  // this.allActions.push([]);
                                  _this55.allCatogeriesActions[i]['actions'] = [];
                                }
                                ...
                                if (apiCallingCount == _this55.allCatogeries.length) {
                                  console.log('Final call can be Done here.');
                                  console.log('All Categories.');
                                  console.log(_this55.allCatogeries);
                                  console.log('All Categories with actions.');
                                  console.log(_this55.allCatogeriesActions);
        ...
        value: function openDeleteConfirmDialog(action) {
          ...
          this.api.deleteActions(this.globals.enterprisedId, action.action_id).subscribe(function (result) {
            ...
            if (result.status == 200) {
              ...
              _this56.getCategoriesforActions();
            } else {
        ...
        key: "clickheader",
        value: function clickheader(data, src) {
          if (src == 'find') {
              ...
              while (1) {
                switch (_context4.prev = _context4.next) {
                  case 0:
                    ...
                    if (!(event.previousContainer.id == 'moviesList' && event.container.id == 'dayList')) {
                      _context4.next = 4;
                      break;
                    }
                  ...
                  case 9:
                    ...
                    _context4.next = 12;
                    return this.modalController.create({
                      component: _action_date_action_date_page__WEBPACK_IMPORTED_MODULE_10__["ActionDatePage"],
                      cssClass: 'action-modal-new'
                    });

                  case 12:
                    modal4 = _context4.sent;
                    _context4.next = 15;
                    return modal4.present();
                  ...
                  case 18:
                    ...
                    for (i = 0; i < this.chunkActions.length; i++) {
        ...
        value: function getCreatePageDropdownData() {
          ...
          this.api.getPriorities(this.globals.enterprisedId).subscribe(function (result) {
            if (result.status == 200) {
              _this57.ActionPriorities = result.body;
          ...
          this.api.getObjectives(this.globals.userId, this.globals.enterprisedId).subscribe(function (result) {
            ...
            if (result.status == 200) {
              _this57.Allobjectives = result.body;
            } else {}
          }, function (error) {
        ...
        value: function triggerQUickAction(event) {
          ...
          this.api.createActions(quick_actions).subscribe(function (result) {
            ...
            _this58.globals.hideLoading();

            if (result.status == 200) {
              //this.sweetAlertDisplay("Action created successfully", true);
              _this58.quickActionName = '';

              _this58.globals.hideLoading();

              _this58.getCategoriesforActions();
            } else {
            ...
            _this58.globals.hideLoading(); //this.sweetAlertDisplay("Action Creation failed, Try Again", false);
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common__WEBPACK_IMPORTED_MODULE_8__["DatePipe"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["Platform"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"], _services_api_services_service__WEBPACK_IMPORTED_MODULE_7__["ApiServicesService"], _services_globals_service__WEBPACK_IMPORTED_MODULE_6__["GlobalsService"]])], ActionsPage);
    /***/
  }
}]);
