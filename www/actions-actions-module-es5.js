      ...
      _createClass(ActionsPage, [{
        ...
        value: function onDropDate(event, date) {
          ...
          if (event.previousContainer === event.container) {
            ...
            Object(_angular_cdk_drag_drop__WEBPACK_IMPORTED_MODULE_4__["transferArrayItem"])(event.previousContainer.data, event.container.data, event.previousIndex, event.currentIndex); //this.modalRef = this.modalService.show(AddDateComponent, { class: 'gray modal-md' });
          }
        }
      }, {
