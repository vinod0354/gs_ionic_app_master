  ...
  function srcAppActionsActionsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ActionsPage = /*#__PURE__*/function () {
      function ActionsPage(datapipe, platform, modalController, api, globals) {
        ...
        this.dodate = true;
        this.duedate = false; // Do Tabs //
        // isCategory = true;

        this.isDo = true;
        this.isDue = false; // isPriority = false;
        // isCategoryEnb = "normal";

        this.isDoEnb = "bold";
        this.isDueEnb = "normal"; // isPriorityEnb = "normal";
        // isCaActive = "#363648"

        this.isDoActive = "#265b8f";
        this.isDuActive = "#363648"; // isPrActive = "#363648"
        // End Do Tabs //
        //Actions Data
      ...
      _createClass(ActionsPage, [{
        ...
        value: function ngOnInit() {
          ...
          for (var _i2 = 0; _i2 <= this.otherdays; _i2++) {
            if (_i2 == 0) {
              this.anotherdate.push({
                displayDate1: 'Another date',
                formatDate: moment__WEBPACK_IMPORTED_MODULE_9__().add(_i2, 'days').format('YYYY-MM-DD'),
                actions: [],
                id: "chooseDate"
              });
            }
        ...
        value: function click_Do() {
          console.log("clicked click_Category"); // this.isCategory = false;

          this.isDo = true;
          this.isDue = false; // this.isPriority = false;
          // this.isCategoryEnb = "normal";

          this.isDoEnb = "bold";
          this.isDueEnb = "normal"; // this.isPriorityEnb = "normal";
          // this.isCaActive = "#363648";

          this.isDoActive = "#265b8f";
          this.isDuActive = "#363648"; // this.isPrActive = "#363648"
        ...
        value: function click_Due() {
          ...
          this.isDo = false;
          this.isDue = true; // this.isPriority = false;
          // this.isCategoryEnb = "normal";

          this.isDoEnb = "normal";
          this.isDueEnb = "bold"; // this.isPriorityEnb = "normal";
          // this.isCaActive = "#363648";

          this.isDoActive = "#363648";
          this.isDuActive = "#265b8f"; // this.isPrActive = "#363648"
            ...
            if (result.status == 200) {
              ...
              for (var i = 0; i < result.body.length; i++) {
                ...
                if (i == result.body.length - 1) {
                  ...
                  for (var _i3 = 0; _i3 < _this54.allCatogeries.length; _i3++) {
                    if (_this54.allCatogeries[_i3].name == 'Miscellaneous') {
                      _this54.miscellaneousCatogeryID = _this54.allCatogeries[_i3].category_id;
                    }
                  }
        ...
        value: function onDrop(event) {
          return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
            var substract_index, i;
            return regeneratorRuntime.wrap(function _callee3$(_context4) {
              while (1) {
                switch (_context4.prev = _context4.next) {
                  case 0:
                    console.log('Event Triggered....');
                    console.log(event); // if (this.dumpActions == 0) {
                    // }
        ...
        key: "onDropDate",
        value: function onDropDate(event, date) {
          console.log('Event Triggered....');
          console.log(event); // if (this.dumpActions == 0) {
          // }
          ...
          if (event.previousContainer === event.container) {
            ...
            Object(_angular_cdk_drag_drop__WEBPACK_IMPORTED_MODULE_4__["transferArrayItem"])(event.previousContainer.data, event.container.data, event.previousIndex - 2, event.currentIndex); //this.modalRef = this.modalService.show(AddDateComponent, { class: 'gray modal-md' });
          }
        }
      }, {
        key: "anotherDate",
        value: function anotherDate(event, date) {
            ...
            return regeneratorRuntime.wrap(function _callee4$(_context5) {
              while (1) {
                switch (_context5.prev = _context5.next) {
                  ...
                  case 9:
                    if (!(event.container.id == 'chooseDate')) {
                      _context5.next = 19;
                      break;
                    }
        ...
        value: function processCalenderEvents(datedata) {
          ...
          for (var i = 0; i < this.doActions.length; i++) {
            ...
            if (i == this.doActions.length - 1) {
              ...
              for (var _i4 = 0; _i4 < this.markedDays.length; _i4++) {
                if (_i4 == 0) {
                  filter_list.push(this.markedDays_strings[_i4]);
                  assign_list.push(this.markedDays[_i4]);
                } else {
                  if (filter_list.includes(this.markedDays_strings[_i4])) {//skip
                  } else {
                    filter_list.push(this.markedDays_strings[_i4]);
                    assign_list.push(this.markedDays[_i4]);
                  }
                ...
                if (_i4 == this.markedDays.length - 1) {
