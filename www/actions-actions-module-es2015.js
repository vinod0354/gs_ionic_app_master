...
/* harmony import */ var _action_date_action_date_page__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../action-date/action-date.page */ "./src/app/action-date/action-date.page.ts");
...
let ActionsPage = class ActionsPage {
    ...
    onDrop(event) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            else if (event.container.id == 'dayList') {
                // this.modalRef = this.modalService.show(AddDateComponent, { class: 'gray modal-md' });
                const modal4 = yield this.modalController.create({
                    component: _action_date_action_date_page__WEBPACK_IMPORTED_MODULE_10__["ActionDatePage"], cssClass: 'action-modal-new'
                });
                return yield modal4.present();
            }
            else {
